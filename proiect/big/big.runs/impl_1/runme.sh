...
HD_PWD='C:/Users/iulia/Desktop/cti-an-3/SSC/proiect/big/big.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modulul_principal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modulul_principal.tcl -notrace
