...
HD_PWD='C:/Users/iulia/Desktop/cti-an-3/SSC/proiect/big/big.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulul_principal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulul_principal.tcl
